    ...
    try:
        ...
        while True:
            try:
                ...
                print("attack:","P0",attack0_hex,"P1",attack1_hex,"P2",attack2_hex,"P3",attack3_hex,"P4",attack4_hex,"P5",attack5_hex,"P6",attack6_hex)
                ...
                print("HH_ts1:","ts1_0",ts10_dec,"ts1_1",ts11_dec,"ts1_2",ts12_dec,"ts1_3",ts13_dec,"ts1_4",ts14_dec,"ts1_5",ts15_dec,"ts1_6",ts16_dec)
                ...
                print("HH_ts2:","ts2_0",ts20_dec,"ts2_1",ts21_dec,"ts2_2",ts22_dec,"ts2_3",ts23_dec,"ts2_4",ts24_dec,"ts2_5",ts25_dec,"ts2_6",ts26_dec)
                ...
                print("HH_ts3:","ts3_0",ts30_dec,"ts3_1",ts31_dec,"ts3_2",ts32_dec,"ts3_3",ts33_dec,"ts3_4",ts34_dec,"ts3_5",ts35_dec,"ts3_6",ts36_dec)
                ...
                print("inf:",inf0,inf1,inf2,inf3,inf4,inf5,inf6)
                print('sum:', inf0+inf1+inf2+inf3+inf4+inf5+inf6)
                print('avg:', (inf0+inf1+inf2+inf3+inf4+inf5+inf6)/7)
                print("++++++++++++++++++++++++++++++++++++++++++++++++")
                time.sleep(1/sps)
