    ...
    try:
        ...
        while True:
            try:
                ...
                print("attack:","P0",attack0_hex,"P1",attack1_hex)
                ...
                print("HH_ts1:","ts1_0",ts10_dec,"ts1_1",ts11_dec)
                ...
                print("HH_ts2:","ts2_0",ts20_dec,"ts2_1",ts21_dec)
                ...
                print("HH_ts3:","ts3_0",ts30_dec,"ts3_1",ts31_dec)
