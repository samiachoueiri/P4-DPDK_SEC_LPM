...
def get_a_k (train):
    ...
    # if optimal_a_de <0.1:
    #     optimal_a_de = optimal_a_de + 0.05
...
trace = "day_flood_20250409.txt"
opt_rate = 900
#initial a and k
k = 5
a = 0.55271215413236695
...
with open("out.txt", "w") as file:
    ...
    for i in range(len(chunks)):
        ...
        if a_push > 1 :
            a_push = 1
        elif (a_push < 0.6 and a_push > 0.45):
            a_push = a_push + 0.1
        print("opt_a",a, "->", a_push)
        a = a_push
