...
ben, = plt.plot(time[0:11],init1_tx, label='Received traffic',color='#3a7cb3',linewidth=3, alpha=0.8)

y_min = 1
y_max = 1.25
plt.fill_between(time[0:23], y_min, y_max, color='#c4daec', alpha=0.5, label='Allowed margin')
y_min = 1
y_max = 1.5
plt.fill_between(time[22:53], y_min, y_max, color='#c4daec', alpha=0.5)
y_min = 1
y_max = 1.25
plt.fill_between(time[52:61], y_min, y_max, color='#c4daec', alpha=0.5)


flood5_tx = [0.9984, 4.131072, 4.988544, 4.987776, 4.986624, 4.987392, 4.988544, 4.992, 4.995072, 4.992, 4.990848,4.990464, 1.35168]
flood5_rx = [0.9984, 1.817856, 1.184256, 1.184268, 1.184256, 1.184256, 1.184256, 1.184256, 1.184256, 1.184256, 1.184256, 1.184256, 0.938432]
plt.plot(time[10:23],flood5_rx, color='#3a7cb3',linestyle='dotted',linewidth=3)
att, = plt.plot(time[10:23],flood5_tx,color='#3a7cb3',linewidth=3, alpha=0.8)

range1_2_tx = [1.35168, 1.199616, 1.199232, 1.199232, 1.199616, 1.199232, 1.199616, 1.199616, 1.2]
range1_2_rx = [0.938432, 1.132032, 1.19808, 1.199232, 1.199232, 1.199232, 1.200384, 1.199232, 1.2]
plt.plot(time[22:31],range1_2_rx, color='#3a7cb3',linestyle='dotted',linewidth=3)
plt.plot(time[22:31],range1_2_tx,color='#3a7cb3',linewidth=3, alpha=0.8)
...
plt.plot(time[30:41],flood10_rx, color='#3a7cb3',linestyle='dotted',linewidth=3)
plt.plot(time[30:41],flood10_tx,color='#3a7cb3',linewidth=3, alpha=0.8)

flood20_tx = [9.972096, 17.44704, 19.871232, 19.882728, 19.888536, 19.896192, 19.891572, 19.87284, 19.85598, 19.877208, 19.883808,8.720064,0.999168]
flood20_rx = [1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304, 1.442304,1.442304,0.916224]
plt.plot(time[40:53],flood20_rx, color='#3a7cb3',linestyle='dotted',linewidth=3)
plt.plot(time[40:53],flood20_tx,color='#3a7cb3',linewidth=3, alpha=0.8)

final1_tx = [0.999168, 0.998784, 1.001088, 0.999168, 0.999552, 0.999552, 1.000704, 0.999168, 0.999168]
final1_rx = [0.916224, 1.00032, 0.999936, 0.999168, 0.999552, 0.999936, 0.999552, 0.999948, 0.999168]
plt.plot(time[52:61],final1_rx, color='#3a7cb3', label='Processed traffic',linestyle='dotted',linewidth=3)
plt.plot(time[52:61],final1_tx,color='#3a7cb3',linewidth=3, alpha=0.8)
...
plt.legend(bbox_to_anchor=(0, 1.29, 1, 0), loc="upper center", ncol=3, mode="expand", borderaxespad=0,frameon=True, fontsize=30-2,handlelength=1.5,labelspacing=0.05)
