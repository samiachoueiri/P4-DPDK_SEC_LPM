...
plt.plot(time[10:23],flood5_rx, color='#95253B',linestyle='dotted',linewidth=3)
att, = plt.plot(time[10:23],flood5_tx, label='Flood traffic',color='#95253B',linewidth=3, alpha=0.8)
...
plt.plot(time[40:53],flood20_rx, color='#95253B',linestyle='dotted',linewidth=3)
plt.plot(time[40:53],flood20_tx,color='#95253B',linewidth=3, alpha=0.8)
...
plt.plot(time[52:61],final1_rx, color='#3a7cb3',linestyle='dotted',linewidth=3)
