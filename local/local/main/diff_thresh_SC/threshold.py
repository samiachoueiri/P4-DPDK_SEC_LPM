            ...
            while True:
                try:
                    ...
                    if prediction == True and skip_k == 0: 
                        print("predicted:",syn_persec_pred,"VS. actual:",last_k[-1])
                        e_ratio = syn_persec_pred / last_k[-1] if last_k[-1] != 0 else float('inf')
                    ...
                    drop_command = f"pipeline PIPELINE1 regwr syn_flood_syn_drop_percent_reg value {int(drop_percent)} index 0\n"
